...
import com.tuanhung.project2.adapters.ReventConversationAdapter;
...
public class MainActivity extends BaseActivity implements ConversionListener {
    ...
    private ReventConversationAdapter conversationAdapter;
    ...
    private void init() {
        ...
        conversationAdapter = new ReventConversationAdapter(conversations, this);
    ...
    private void setListeners() {
        ...
        binding.imageProfile.setOnClickListener(v -> startActivity(new Intent(getApplicationContext(), Profile.class)));
    }
