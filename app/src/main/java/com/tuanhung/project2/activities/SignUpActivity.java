...
public class SignUpActivity extends AppCompatActivity {
    ...
    private Boolean isValidSignUpDetails() {
        if(encodedImage == null) {  // thiếu ảnh đại diện
            ...
            return false;
        } else if (binding.inputName.getText().toString().trim().isEmpty()) { // thiết tên
            showToast("Enter name");
            return false;
        } else if (binding.inputEmail.getText().toString().trim().isEmpty()) { // thiếu email
            showToast("Enter email");
            return false;
        } else if (!Patterns.EMAIL_ADDRESS.matcher(binding.inputEmail.getText().toString()).matches()) { // email không hợp lệ
